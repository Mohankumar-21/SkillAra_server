...
export const ERROR_MESSAGES = {
  ...
  COURSE_REVIEW_REQUIRED:
    "This course must be approved by a content reviewer before it can be published.",
  COURSE_REVIEW_PENDING: "This course is already awaiting content review.",
  COURSE_REVIEW_APPROVED: "This course is already approved and ready to publish.",
  COURSE_REVIEW_NOT_PENDING: "There is no pending review to decide on for this course.",
  COURSE_REVIEW_NOT_ASSIGNED: "Only the assigned content reviewer can review this course.",
  COURSE_REVIEW_INVALID: "This review action is not valid for the course's current state.",
  COURSE_REVIEWER_INVALID: "Select a content reviewer from your organization.",
  COURSE_REVIEWER_UNAVAILABLE:
    "No content reviewer is available. Ask an admin to assign someone the Content Reviewer role.",
  COURSE_REVIEW_NOTE_REQUIRED: "Tell the instructor what needs to change.",
  NOTIFICATION_NOT_FOUND: "Notification not found.",
  ENROLLMENT_NOT_PENDING: "This request has already been decided.",
  ENROLLMENT_ALREADY_ACTIVE: "This learner already has access to that course.",
